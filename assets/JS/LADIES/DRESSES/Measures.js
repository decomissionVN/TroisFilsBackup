...
function simulator__menu_measures_mobile() {
        ...
        navigator_menu += `<a href="../../ladies/dresses/Ladies_Dresses_Simulator.html" class="w-100" alt="Step ${i}" onclick="simulator__relocate_from_measures(${i})">
                                <div class="row mb-1 Row_white">
                                    <div class="col-2 m-auto">
                                        <img class="m-auto navigation__modify" id="${QueryParams_categories[i]}_navigation_measures_modify" src="https://troisfils.com/assets/IMAGES/SIMULATOR/MEASURES/Modify.png" alt="${QueryParams_categories[i]}" />
                                    </div>
                                    <div class="col-2 m-auto">
                                        <img class="m-auto navigation__number" id="${QueryParams_categories[i]}_navigation_measures" src="https://troisfils.com/assets/IMAGES/SIMULATOR/NAVIGATOR/Nav_${i + 1}_filled.png" alt="${QueryParams_categories[i]}" />
                                    </div>
    ...
    let Simulator_preview_measures_simul = `<div class="Sticky_Position">
                                    ...
                                    <div id="simulator__window_fabric_measures">
                                        <img class="full" src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/TEXTURE/${_fabric}.png" alt="fabric image"/>
                                    </div>
                                    ...
                                    <div id="simulator__window_top"><img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/TOP/SHOULDERS/${_model}/Model_${_model}_Shoulder_${_shoulder}_preview.png" alt="Top image"/></div>
                                    <div id="simulator__window_bottom"><img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/BOTTOM/STYLE/${_model}/Model_${_model}_Style_${_style}_preview.png" alt="Bottom image"/></div>
                                </div>`
...
function simulator__preview_selection(_model, _shoulder, _style, _back, _fabric, _color) {
    document.getElementById('simulator__measures_preview_Model').innerHTML = `<img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/TOP/MODEL/Model_${_model}_preview.png" alt="back model image"/>`;
    document.getElementById('simulator__measures_preview_Shoulder').innerHTML = `<img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/TOP/SHOULDERS/${_model}/Model_${_model}_Shoulder_${_shoulder}_preview.png" alt="front cut image"/>`;
    document.getElementById('simulator__measures_preview_Style').innerHTML = `<img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/BOTTOM/STYLE/${_model}/Model_${_model}_Style_${_style}_preview.png" alt="front style image"/>`;
    document.getElementById('simulator__measures_preview_Back').innerHTML = `<img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/BACK/TOP/SHOULDERS/${_model}/Model_${_model}_Shoulder_${_shoulder}_preview.png" alt="front shoulders image"/>`;
    document.getElementById('simulator__measures_preview_Fabric').innerHTML = `<img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/TEXTURE/${_fabric}.png" alt="front sleeves image"/>`;
    ...
    if (creations_display.length > 0) {
        ...
        for (let i = 0; i < creations_display.length; i++) {
            previous_creations += `<div class="simulator__window_previous" id="simulator__window_previous_${i}">
                                        <a href="#" onclick="confirm_remove_element_from_array(${i})" id="simulator__window_previous_delete_${i}" aria-label="delete"><img src="https://troisfils.com/assets/IMAGES/SIMULATOR/MEASURES/Delete_icon.png" alt="remove" class="remove_icon"/></a>
                                        <div class="Full_Preview_Past">
                                            <div class="simulator__window_top_Measures">
                                            <img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/TOP/SHOULDERS/${creations_display[i][0]._model}/Model_${creations_display[i][0]._model}_Shoulder_${creations_display[i][0]._shoulder}_preview.png" alt="Tailor's creation preview" class="previous_designs"/>
                                                </div>
                                            <div class="simulator__window_bottom_Measures">
                                                <img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/BOTTOM/STYLE/${creations_display[i][0]._model}/Model_${creations_display[i][0]._model}_Style_${creations_display[i][0]._style}_preview.png" alt="Tailor's creation preview" class="previous_designs"/>
                                            </div>
                                        </div>
                                   </div>`
        }
    ...
    document.getElementById('simulator__past_simulation').innerHTML = `<div class="row">
                                                                           <div class="col-5 col-sm-6 delete_simul">
                                                                                <div class="simulator__window_top">
                                                                                    <img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/TOP/SHOULDERS/${creations_display[value][0]._model}/Model_${creations_display[value][0]._model}_Shoulder_${creations_display[value][0]._shoulder}_preview.png" alt="Tailor's creation preview" class="previous_designs"/>
                                                                                </div>
                                                                                <div class="simulator__window_bottom">
                                                                                    <img src="https://troisfils.com/assets/IMAGES/LADIES/DRESSES/PREVIEWS/FRONT/BOTTOM/STYLE/${creations_display[value][0]._model}/Model_${creations_display[value][0]._model}_Style_${creations_display[value][0]._style}_preview.png" alt="Tailor's creation preview" class="previous_designs"/>
                                                                                </div>
                                                                           </div>
                                                                           <div class="col-7 col-sm-6 m-auto text-center Previous_Simul">
                                                                                <img src="https://troisfils.com/assets/IMAGES/SIMULATOR/MEASURES/Sure_verification.png" alt="Remove tailoring item" id="sure_verification"/>
...
function measures__display_options() {
    ...
    document.getElementById('measures__general-section').innerHTML = `<h2 class="text-center pt-5 pb-4">How do you wish to take your measures?</h2>
                                                                     <div class="row section__grey mb-3" data-aos="fade-right" data-aos-easing="ease" data-aos-delay="400" data-aos-duration="1500">
                                                                           <div class="col-md-6">
                                                                                <img src="https://troisfils.com/assets/IMAGES/HOME/Tailor.jpg" alt="Tailor's appointment" class="fit"/>
                                                                           </div>
                                                                           <div class="col-md-6 text-center">
                                                                                ...
                                                                                <a href="../ladies/Appointment.html" class="button mb-5">See the availibilities</a>
                                                                            </div>
                                                                       </div>
...
function simulator__relocate_from_measures(step) {
    event.preventDefault();
    if (step === 0) {
    ...
    function relocate_step() {
        let queryParams = new URLSearchParams(window.location.search);
        window.location.replace("../ladies/dresses/Ladies_Dresses_Simulator.html" + "?" + queryParams.toString());
    }
}
...
function User_logged() {
    ...
    if (token === null || token === {}) {
        ...
        document.getElementById('Online_Measures').innerHTML = `<a href="../Dashboard/Dashboard.html" class="button">Use my measures</a>`
    }
}
