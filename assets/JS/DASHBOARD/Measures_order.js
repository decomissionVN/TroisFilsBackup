...
function User_already_measured() {
    ...
    if (token == null || userId == null){
        ...
        fetch('https://api.troisfils.com/api/auth/measuresGet' + '/' + userId.userId, { method: "GET", headers: { 'Authorization': 'bearer ' + token.token_access }}).then(response => response.text()).then(response => display_measure_saved(response))
...
function Signup_measures() {
    ...
    if (user.name === "") {
        ...
        Clear_Style_Signup_Form();
        fetch('https://api.troisfils.com/api/auth/signup', { method: "POST", headers: { 'Content-Type': "application/json" }, body: JSON.stringify(user) }).then(response => response.json()).then(response => user_saved_signup_measures(response))
            .catch(function (error) {
