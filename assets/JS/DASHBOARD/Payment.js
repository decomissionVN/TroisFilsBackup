...
function User_exists(translation) {
    ...
    if (token && userId) {
        fetch('https://api.troisfils.com/api/orders/orderGetOne' + '/' + orderId, { method: "GET", headers: { 'Authorization': 'bearer ' + token.token_access }}).then(response => response.json()).then(response => display_order(response, translation, orderId))
...
function change_status(status){
    ...
    if (token && userId) {
        fetch('https://api.troisfils.com/api/orders/orderGetOne' + '/' + orderId, { method: "GET", headers: { 'Authorization': 'bearer ' + token.token_access }}).then(response => response.json()).then(response => update_status(response, status))
        .catch(function (error) {
            console.log('GET ' + error.message)
        })
    }   
...
function update_status(response, status){
    ...
    fetch('https://api.troisfils.com/api/orders/orderUpdateOne' + '/' + orderId, { method: "PUT", headers: { 'Content-Type': "application/json", 'Authorization': 'bearer ' + token.token_access }, body: JSON.stringify(order_new) }).then(response => response.json()).then(response => reload_page(response))
    .catch(function (error) {
