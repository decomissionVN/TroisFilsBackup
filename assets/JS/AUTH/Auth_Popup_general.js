...
function Login_content() {
    ...
    if (language === 'fr') {
        let translation = { ShowPassword : "Afficher le mot de passe", GetBack : "Recupérer le mot de passe", EnterEmail : "Renseignez votre mail", Forgot : "Mot de passe oublié", Welcome_Login : "Bienvenue sur votre espace tailleur", Signup : "Inscription", Password_Wrong : "Mot de passe incorrect", Password_Empty : "Veuillez renseigner un mot de passe", Login : "Connexion", Email : "Email", Warn_Email_Empty : "Veuillez renseigner votre Email", Warn_W_Email : "Aucun compte ne correspond à cette adresse", Password : "Mot de Passe" 
        }
        Login_content_translated(translation)
    } else {
        let translation = { ShowPassword : "Display Password", GetBack : "Get back my password", EnterEmail : "Enter your Email", Forgot : "Forgotten Password?", Welcome_Login : "Welcome to your tailoring account", Signup : "Signup", Password_Wrong : "The password is incorrect", Password_Empty : "Please enter a password", Login : "Login", Email : "Email", Warn_Email_Empty : "Please enter your Email", Warn_W_Email : "No account was created with this Email", Password : "Password" 
        }
        Login_content_translated(translation)
    }
    ...
    function Login_content_translated(translation){
        let form_login = `<p>${translation.Welcome_Login}</p>
                        <form method="post" id="contact" autocomplete="on">
                                ...
                                <input type="password" name="Password" id="Password" placeholder="${translation.Password}" required>
                                <div id="Password_warn">${translation.Password_Empty}</div>
                                <div id="Password_warn_nomatch">${translation.Password_Wrong}</div>

                                <input type="checkbox" id="passwordshow"><i>${translation.ShowPassword}</i>
                        ...
                        <div class="mt-5">
                            <a href="#" class="black" id="submitorder_forgot" onclick="Forgot()">${translation.Forgot}</a>
                        </div>
        ...
        document.getElementById('passwordshow').addEventListener('click', function showpsw() {
...
function display(response){
    ...
    let language = localStorage.getItem("language");
    if (language === 'fr') {
        let translation = { Email_sent : "Un Email vous a été envoyé. Veuillez vérifier votre boite de réception.. En cas de non réception, n'oubliez pas de vérifier les spams!" 
        }
