...
function language_used(){
    ...
    if (language === 'fr'){
        let translation = {
            Title_Page : "Trois Fils | Tailleur sur mesure pour Femme | Rendez-vous Lady",
            ...
            title_uniform : "Uniformes sur mesure | Lady",
            ...
            realisation_para : "Nos tailleurs sont à votre disposition! Pour une robe de soirée, un tailleur ajusté ou une robe de mariée, notre expertise vous promet un produit de qualité permettant de réhausser votre apparence pour toutes les occasions.",
            ...
            create_simulator : "Explorez les possibilités avec notre simulateur!",
            create_simulator2 : "Nous avons implémenté pour vous un simulateur vous permettant de combiner les designs les plus demandées pour vos tenues cette année. La création de chaque pièce étant unique, un entretien avec votre tailleur personnel sera toujours nécessaire pour finaliser ce design.",
            create_simulator3 : "Créer ma robe",
        } 
        ...
        let translation = {
            ...
            create_simulator : "Explore the possibilities with our simulator!",
            create_simulator2 : "We developped for you a simulator allowing you to combine the most asked designed for tailored outfits this year. The creation of each dress being unique, it will always be needed to scheddule an appointment with your personal tailor in order to finalize your design and your order.",
            create_simulator3 : "Create my dress",
        }
        display_footer(translation);
        insert_the_HTML(translation);
        User_logged(translation);
...
function insert_the_HTML(translation){
    ...
    let dress_page = document.getElementById('subtitle_app');
    let wedding_page = document.getElementById('subtitle_app_wedding');
    let suit_page = document.getElementById('subtitle_app_suit');
    if(dress_page){
        ...
        document.getElementById('create_simulator').innerHTML = translation.create_simulator;
        document.getElementById('create_simulator2').innerHTML = translation.create_simulator2;
        document.getElementById('create_simulator3').innerHTML = translation.create_simulator3;
    } else if(wedding_page){
        document.getElementById('subtitle_app_wedding').innerHTML = translation.subtitle_app_wedding;
        document.getElementById('create_tailor2_wedding').innerHTML = translation.create_tailor2_wedding;
        document.getElementById('create_simulator').innerHTML = translation.create_simulator;
        document.getElementById('create_simulator2').innerHTML = translation.create_simulator2;
        document.getElementById('create_simulator3').innerHTML = translation.create_simulator3;
    } else if(suit_page){
        document.getElementById('subtitle_app_suit').innerHTML = translation.subtitle_app_suit;
        document.getElementById('create_tailor2_suit').innerHTML = translation.create_tailor2_suit;
    }
}
