...
function display_appointment(language){
if (language === 'english'){
    console.log('english');
    document.getElementById('calendly_insert_french').style.display = 'none';
    document.getElementById('calendly_insert_english').style.display = 'block';
} else if (language === 'french') {
    console.log('french');
    document.getElementById('calendly_insert_french').style.display = 'block';
    document.getElementById('calendly_insert_english').style.display = 'none';
}
}
