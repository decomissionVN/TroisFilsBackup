...
function language_used(){
    ...
    if (language === 'fr'){
        let translation = {
            create_tailor2_wedding : "Créez votre smoking sur mesure en prenant un rendez-vous.",
            subtitle_app_wedding : "Vous allez commander votre smoking sur mesure. Pour permettre à nos tailleurs de comprendre vos gouts et vos attentes, vous pouvez discuter avec le tailleur ou soumettre une photo d'un costume que vous aimez.",
...
function insert_the_HTML(translation){
    document.getElementById('Title_Page_Wedding').innerHTML = translation.Title_Page_Wedding; 
