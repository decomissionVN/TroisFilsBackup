...
function language_used(){
    ...
    if (language === 'fr'){
        let translation = {
            ...
            contact_home : "Contactez notre service client",
            contact_home_sub : "Vous pouvez nous contacter par Whatsapp, Messanger, Email ou Téléphone!",
            tailoring_contact : "Votre tailleur de contact",
            tailoring_contact_para : "Vous pouvez contacter notre service client ou créer un compte pour contacter votre tailleur personnel. Ce tailleur sera à votre disposition pour vous aider à trouver et confectionner des tenues d'exception à tout moment.",
            tailoring_contact_para1 : "Nous sommes très heureux de vous rendre service, et nous ferons le nécessaire pour vous apporter le meuilleur support et service.",
        ...
        let translation = {
            ...
            contact_home : "Contact our customer support",
            contact_home_sub : "You can contact us by Whatsapp, Messanger, Email or Phone!",
            tailoring_contact : "Tailoring contact",
            tailoring_contact_para : "You can contact our customer service or create an account to contact your personal tailor. This tailor will be at your disposal to help you to find the best suit everytime you ask.",
            tailoring_contact_para1 : "We will be very glad to assist you, and will do our very best to provide you the best customer support and advises.",
...
function insert_the_HTML(translation){
    ...
    document.getElementById('contact_home').innerHTML = translation.contact_home;
    document.getElementById('contact_home_sub').innerHTML = translation.contact_home_sub;
    document.getElementById('tailoring_contact').innerHTML = translation.tailoring_contact;
    document.getElementById('tailoring_contact_para').innerHTML = translation.tailoring_contact_para;
    document.getElementById('tailoring_contact_para1').innerHTML = translation.tailoring_contact_para1;
